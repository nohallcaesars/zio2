package com.nohall.foss.careg.repo

import zio.test._
import zio.test.Assertion._
import zio.test.TestAspect._
import zio._
import com.nohall.foss.careg.repo.postgresql._
import com.nohall.foss.careg.domain._
...
object PostgresRunnableSpec extends ZIOSpecDefault:
  ...
  val dataSourceLayer =
    DataSourceBuilderLive.layer.flatMap(builder => 
      ZLayer.fromFunction(() => builder.get.dataSource)
    )
